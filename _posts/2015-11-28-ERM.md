...
- Training set: $$S$$ of size $$|S| = m$$ - This is the set of training samples and its training labels.
...
we argue about the accuracy of the learned hypothesis $$h$$ compared to $$f$$?
