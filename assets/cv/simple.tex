...
\par{\centering{\Huge Hoang \textsc{Nguyen}}\bigskip\par} % Your name

\section{Personal Data}

\begin{tabular}{rl}
\textsc{Address:} & Room E504, West 8E Building, 2-12-1 Ookayama, Meguro, Tokyo, Japan\\
\textsc{Phone:} & +81-3-5734-2684\\
\textsc{email:} & \href{mailto:hoangnt@acm.org}{hoangnt@acm.org}
\end{tabular}
...
\emph{Current} & 1\textsuperscript{st} year Teaching Assistant at \textsc{Tokyo Insitute of Technology}, Tokyo \\
