...
about ERM scheme and some proofs around it.
...
over the training data $$S$$. It is possible that  The weakness of _empirical risk_ (or empirical loss) is when the
...
{{%include Titanic_Survival_Exploration_p3.html%}}
