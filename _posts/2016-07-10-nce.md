...
So far, noise contrastive estimation technique ([NCE](https://www.jmlr.org/papers/v13/gutmann12a.html) - by [Michael Gutmann](https://sites.google.com/site/michaelgutmann/home) and Aapo Hyvarinen) is my favorite technique for distribution estimation. I like this technique because it's one of the technique where you deal with the problem by not directly solve the problem - It's the best! 
