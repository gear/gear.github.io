---
layout: post
title:  "Greedy submodular function maximization analysis"
date:   2016-06-18
...
<center>How well can greedy algorithm performs</center>
     
## About
     
I $$\sigma_i = f(S_{i+1} - f(S_{i})$$ =  made this theme after seeing this [screenshot](http://spoonm.org/share/rice/01.png). I took some parts from @mmistakes, like TOC, sample posts. I never tought making a theme from scratch would be this hard. And it's still WIP.
