...
one might think about analyzing text with graph methods and vice versa. A picture
from the Deepwalk paper illustrates this idea:

![Power-law distributions]({{site.baseurl}}/img/power-law-text-graph.png) TODO
