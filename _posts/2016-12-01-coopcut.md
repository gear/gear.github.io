...
and a nondecreasing submodular function $$f : 2^{\Epsilon} \rightarrow \mathcal{R}_{+}$$
defined on subsets of edges $$\Epsilon$$, find an $$(s,t)-cut \Gamma \subeq \Epsilon$$ having
