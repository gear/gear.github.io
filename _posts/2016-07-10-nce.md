...
"Too long, didn't read" - No worries. NCE is simple as 1, 2, 3... 4, 5, 6, 7, 8, 9: 
  ...
  3. The classic way to fit your model to the true distribution $$p_d(x)$$ is to maximize the likelihood of your model with a certain $$\alpha$$ and observed data $$\{x_1, ..., x_n\}$$ (MLE - maximum likelihood estimation, also log likelihood in practice).
